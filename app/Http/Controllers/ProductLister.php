...
class ProductLister extends Controller
{
    ...
    public static function get(int $mens=2, string $sortBy="id", bool $ascending=true, int $catFilter=0) {
    ...
    public function show(int $mens=2, string $sortBy="id", bool $ascending=true, int $catFilter=0) {
