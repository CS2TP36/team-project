        ...
        <form>
            ...
            <article>
                <fieldset role="group" style="width: 30%">
                    <input type="number" name="discount" value="25" style="width: fit-content" id="discount" min="1" max="100" required onchange="document.getElementById('slider').value = this.value">
