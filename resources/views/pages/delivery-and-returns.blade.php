        ...
        <div class="container my-5">
            ...
            <section id="return-info" class="content-section" style="display: none;">
                ...
                <p style="font-size: 1.1em; line-height: 1.8; margin-bottom: 20px;">
                    We acknowledge that things don't always go as planned. For your convenience, we have made our
                    returns
                    ...
                    <br><br>
                    Only the postal service is used to handle returns. The return details are with your box. For help,
                    you
                    can also get in touch with us directly.
                    <br><br>
                    <strong>Refunds:</strong> Following processing, refunds may take up to three to five business days
                    to
