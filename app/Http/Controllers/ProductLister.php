...
class ProductLister extends Controller
{
    ...
    public static function get(bool $mens=true, string $sortBy="id", bool $ascending=true, int $catFilter=0) {
    ...
    public function show(bool $mens=true, string $sortBy="id", bool $ascending=true, int $catFilter=0) {
