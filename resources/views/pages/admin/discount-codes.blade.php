        ...
        <form action="{{ route('admin.discounts.add') }}" method="POST">
            ...
            <article>
                <fieldset role="group" style="width: 30%">
                    <input type="number" name="percent_off" value="25" style="width: fit-content" id="discount" min="1"
                           max="100" required onchange="document.getElementById('slider').value = this.value">
                    <p style="text-align: center; margin-top: auto; margin-bottom: auto">% off</p>
                </fieldset>
                <input type="range" id="slider" value="25" min="1" max="100"
                       onchange="document.getElementById('discount').value = this.value">
            </article>
            <input type="submit">
        </form>
    </article>
